metal.ns('metal.media.photoGallery');

/**
 * controls over the photo gallery picker
 * 
 * @singleton
 * @class metal.media.photoGallery
 * @author Amir Lazarovich
 * @version 0.1
 */
metal.media.photoGallery = (function() {
	...
	var defaults = {
		 ...
		 * 
		 * @property {Boolean} saveToPhotoGallery
		 */
		saveToPhotoGallery: undefined,
	...
	return {
		 ...
		 * animated (defaults to true) upon showing and hiding, saveToPhotoGallery 
		...
		open: function(option) {
			dlog('PhotoGallery', 'Opening...');
			option = option || {};
			metal.apply(option, metal.formatProperties(defaults));
			return Titanium.Media.openPhotoGallery(option);
		},
