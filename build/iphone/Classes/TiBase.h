...
// in simulator we redefine to format for MetalProject Developer console
...
{\
	NSString * exceptionName = [@"org.metalproject." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.metalproject";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMetalProjectNativeItemNone = -1, 
	UIMetalProjectNativeItemSpinner = -2,
	UIMetalProjectNativeItemProgressBar = -3,
	
	UIMetalProjectNativeItemSlider = -4,
	UIMetalProjectNativeItemSwitch = -5,
	UIMetalProjectNativeItemMultiButton = -6,
	UIMetalProjectNativeItemSegmented = -7,
	
	UIMetalProjectNativeItemTextView = -8,
	UIMetalProjectNativeItemTextField = -9,
	UIMetalProjectNativeItemSearchBar = -10,
	
	UIMetalProjectNativeItemPicker = -11,
	UIMetalProjectNativeItemDatePicker = -12,
	
	UIMetalProjectNativeItemInfoLight = -13,
	UIMetalProjectNativeItemInfoDark = -14,
	
	UIMetalProjectNativeItemDisclosure = -15,
	
	UIMetalProjectNativeItemContactAdd = -16
};
