...
// in simulator we redefine to format for MetalTest Developer console
...
{\
	NSString * exceptionName = [@"org.metaltest." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.metaltest";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIMetalTestNativeItemNone = -1, 
	UIMetalTestNativeItemSpinner = -2,
	UIMetalTestNativeItemProgressBar = -3,
	
	UIMetalTestNativeItemSlider = -4,
	UIMetalTestNativeItemSwitch = -5,
	UIMetalTestNativeItemMultiButton = -6,
	UIMetalTestNativeItemSegmented = -7,
	
	UIMetalTestNativeItemTextView = -8,
	UIMetalTestNativeItemTextField = -9,
	UIMetalTestNativeItemSearchBar = -10,
	
	UIMetalTestNativeItemPicker = -11,
	UIMetalTestNativeItemDatePicker = -12,
	
	UIMetalTestNativeItemInfoLight = -13,
	UIMetalTestNativeItemInfoDark = -14,
	
	UIMetalTestNativeItemDisclosure = -15,
	
	UIMetalTestNativeItemContactAdd = -16
};
