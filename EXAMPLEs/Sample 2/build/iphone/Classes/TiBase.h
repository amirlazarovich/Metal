...
// in simulator we redefine to format for Sample2 Developer console
...
{\
	NSString * exceptionName = [@"org.sample2." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sample2";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UISample2NativeItemNone = -1, 
	UISample2NativeItemSpinner = -2,
	UISample2NativeItemProgressBar = -3,
	
	UISample2NativeItemSlider = -4,
	UISample2NativeItemSwitch = -5,
	UISample2NativeItemMultiButton = -6,
	UISample2NativeItemSegmented = -7,
	
	UISample2NativeItemTextView = -8,
	UISample2NativeItemTextField = -9,
	UISample2NativeItemSearchBar = -10,
	
	UISample2NativeItemPicker = -11,
	UISample2NativeItemDatePicker = -12,
	
	UISample2NativeItemInfoLight = -13,
	UISample2NativeItemInfoDark = -14,
	
	UISample2NativeItemDisclosure = -15,
	
	UISample2NativeItemContactAdd = -16
};
