...
// in simulator we redefine to format for Sample1 Developer console
...
{\
	NSString * exceptionName = [@"org.sample1." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.sample1";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UISample1NativeItemNone = -1, 
	UISample1NativeItemSpinner = -2,
	UISample1NativeItemProgressBar = -3,
	
	UISample1NativeItemSlider = -4,
	UISample1NativeItemSwitch = -5,
	UISample1NativeItemMultiButton = -6,
	UISample1NativeItemSegmented = -7,
	
	UISample1NativeItemTextView = -8,
	UISample1NativeItemTextField = -9,
	UISample1NativeItemSearchBar = -10,
	
	UISample1NativeItemPicker = -11,
	UISample1NativeItemDatePicker = -12,
	
	UISample1NativeItemInfoLight = -13,
	UISample1NativeItemInfoDark = -14,
	
	UISample1NativeItemDisclosure = -15,
	
	UISample1NativeItemContactAdd = -16
};
